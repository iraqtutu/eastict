...
<body>
	...
	<div class="easyui-panel" title="新建Tview" style="width:400px">
...
<tr>
	<td>viewname:</td>
	<td><input class="easyui-textbox" name="viewname" data-options="prompt:'请输入...',required:true,validType:'length[3,10]'"></td>
</tr>
	...
	<script type="text/javascript">
		var addPage  = {
				submitForm : function (){
					...
					$.post("../Tview/save",$("#formid").serialize(), function(data){
						if(data.status == 200){
