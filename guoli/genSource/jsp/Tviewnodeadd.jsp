...
<body>
	...
	<div class="easyui-panel" title="新建Tviewnode" style="width:400px">
...
<tr>
	<td>name:</td>
	<td><input class="easyui-textbox" name="name" data-options="prompt:'请输入...',required:true,validType:'length[3,10]'"></td>
</tr>
<tr>
	<td>isParent:</td>
	<td><input class="" type="checkbox" name="isParent"></td>
</tr>
	...
	<script type="text/javascript">
		var addPage  = {
				submitForm : function (){
					...
					$.post("../Tviewnode/save",$("#formid").serialize(), function(data){
						if(data.status == 200){
